...
{
    public class SocialMediaLoginForm : FormModule<Domain.User>
    {
        public SocialMediaLoginForm()
        {
            SupportsAdd(false)
                .SupportsEdit(false)
                .Header("<h3>Other ways to sign in</h3>")
            ...
            ViewModelProperty<string>("Provider")
                .FromRequestParam("provider");

            ViewModelProperty<string>("Error")
                .FromRequestParam("error");
